...
console.log(makeCar('Honda', 'Accord'))
...
var salesReport =
    {
        ...
        office: 'Codeup',
        employees : [
            {employeeNumber : 1,  firstName : 'Jane', lastName: 'Janeway' ,salesUnits: 3 },
            {employeeNumber : 3,  firstName : 'Tricia', lastName: 'Triciason',salesUnits: 5 },
            {employeeNumber : 5,  firstName : 'Charles',lastName: 'Emmerson III Winchester',salesUnits: 2},
            {employeeNumber : 6,  firstName : 'Chet',lastName: 'Chedderson',salesUnits: 8},
            {employeeNumber : 7,  firstName : 'Chaiam',lastName: 'Chaiamson',salesUnits: 12 },
            {employeeNumber : 8,  firstName : 'Dale',lastName: 'Dalesinger',salesUnits: 1 },
            {employeeNumber : 9,  firstName : 'Zig',lastName: 'Ziglar',salesUnits: 50},
            {employeeNumber : 10, firstName :  'Henry',lastName: 'Kissinger',salesUnits: 1},
            {employeeNumber : 11, firstName :  'Arthur Herbert',lastName: 'Fonzarelli',salesUnits: 23},
            {employeeNumber : 12, firstName :  'Betty',lastName: 'Boop',salesUnits: 67}
]
}
...
function getEmployeeCount(obj){
    return obj.employees.length
}
function getTotalNumberOfSales(obj){
    let sum = 0;
    obj.employees.forEach(e=> sum += e.salesUnits)
    return sum
}
function getAverageSalesPerEmployee(obj){
    let sum = 0;
    obj.employees.forEach(e=> sum += e.salesUnits)
    return sum / obj.employees.length
}
